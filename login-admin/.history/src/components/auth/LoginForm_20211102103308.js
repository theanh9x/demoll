...
const LoginForm = (props) => {
    ...
    const onFinish = async (values) => {
        try {
            ...
            const token_res = await LoginService.signIn(values.username, values.password, jwt_token)
                ...
                <Form.Item>
                    <div className="action-form">
                        <Form.Item name="remember" valuePropName="checked" noStyle>
                            <Checkbox checked={remember} onChange={onChangeCheck}>Duy trì đăng nhập</Checkbox>
                        </Form.Item>
